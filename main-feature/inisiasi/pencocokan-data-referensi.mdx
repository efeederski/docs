...
<Note>
Misalnya pada data referensi agama Khonghucu, di data Neo Feeder PDDIKTI tertulis Khonghucu. Sedangkan yang ada di database eAkademik masih kosong, sehingga data ini perlu dicocokan. Caranya adalah cari data *Khonghucu* di kolom **gt_id** lalu klik tombol **Save**.
</Note>
